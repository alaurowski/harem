angular.module('crmApp').controller('LeadsDetailsCtrl', ['$scope', 'leads','$location', '$routeParams', '$http', 'FileUploader', function ($scope, leads,$location, $routeParams, $http, FileUploader) {
